...
class ServletRequestSecurityTracerTest {
    ...
    private void doFilterInternal(String requestUriPattern, boolean isRestRequest, int statusCode, boolean traceRequest) {
        ...
        if (requestUriPattern != null) {
            // Only mock method and status code if a request URI pattern could be determined,
            // otherwise the request will not be traced and method and status code are not ued.
