...
public class S3ClientConfiguration {
    ...
    public S3Client s3Client(S3ClientProperties properties, AwsCredentialsProvider awsCredentialsProvider) throws URISyntaxException {
        ...
        if (overrideSigner()) {
            log.info("Using AwsS3V4Signer for S3Client.");
    ...
    private boolean overrideSigner(){
        return CloudPlatform.KUBERNETES.isActive(environment); // after the update of the aws sdk, we need this workaround that it works on Openshift as well
    }
