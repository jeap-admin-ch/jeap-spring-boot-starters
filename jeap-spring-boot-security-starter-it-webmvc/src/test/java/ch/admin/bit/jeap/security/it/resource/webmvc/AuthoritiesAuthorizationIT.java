...
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.DEFINED_PORT, properties = {"server.port=8006"})
@SuppressWarnings("java:S2699") // asserts are in the super class methods, but sonar does not get it
class AuthoritiesAuthorizationIT extends AbstractAuthoritiesAuthorizationIT {
