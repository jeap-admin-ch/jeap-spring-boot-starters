...
class EiamAccessTokenWebfluxIT extends AbstractEiamAccessTokenIT {

	@Autowired
	EiamAccessTokenWebfluxIT(@Value("${server.port}") int serverPort, @Value("${spring.application.name}") String context) {
