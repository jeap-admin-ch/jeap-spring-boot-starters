...
class AccessTokensFromTwoDifferentAuthServersWebfluxIT extends AccessTokensFromTwoDifferentAuthServersITBase {

    protected AccessTokensFromTwoDifferentAuthServersWebfluxIT(@Value("${server.port}") int serverPort, @Value("${spring.application.name}") String context) {
