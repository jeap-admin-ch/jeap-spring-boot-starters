...
class AccessTokensFromTwoDifferentAuthServersOnlyOneConfiguredWebfluxIT extends AccessTokensFromTwoDifferentAuthServersITBase {

    protected AccessTokensFromTwoDifferentAuthServersOnlyOneConfiguredWebfluxIT(@Value("${server.port}") int serverPort, @Value("${spring.application.name}") String context) {
