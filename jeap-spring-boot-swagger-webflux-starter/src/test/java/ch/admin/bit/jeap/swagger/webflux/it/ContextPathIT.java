...
@SpringBootTest(classes = TestConfiguration.class, properties = {"jeap.swagger.status=OPEN", "spring.webflux.base-path=/test", "springdoc.swagger-ui.oauth2-redirect-url=http://localhost/test/webjars/swagger-ui/oauth2-redirect.html"})
