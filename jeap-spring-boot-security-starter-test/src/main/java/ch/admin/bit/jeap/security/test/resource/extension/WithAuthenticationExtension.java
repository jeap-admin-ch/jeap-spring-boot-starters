 ...
 * Add the @WithAuthentication annotation to methods annotated with @Test or @ParameterizedTest.
 */
public class WithAuthenticationExtension implements InvocationInterceptor {
    ...
    public void interceptTestMethod(InvocationInterceptor.Invocation<Void> invocation, ReflectiveInvocationContext<Method> invocationContext, ExtensionContext extensionContext) throws Throwable {
        executeInvocationWithAuthenticationIfAnnotated(invocation, extensionContext);
    }
    ...
    private void executeInvocationWithAuthenticationIfAnnotated(InvocationInterceptor.Invocation<Void> invocation, ExtensionContext extensionContext) throws Throwable {
