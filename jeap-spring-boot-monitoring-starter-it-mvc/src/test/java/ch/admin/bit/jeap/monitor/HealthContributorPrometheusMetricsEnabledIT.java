...
class HealthContributorPrometheusMetricsEnabledIT {
    ...
    void shouldExposeMockDbHealthIndicatorMetric() {
        ...
        assertThat(metrics)
                .contains("health_indicator_status{component=\"db\"} 1.0")
                .contains("health_indicator_status{component=\"ldap\"} 0.0")
                .contains("health_indicator_status{component=\"diskSpace\"}");
    }
