...
class ContextPathIT {
    private static final String SWAGGER_REDIRECT_URL = "/test/swagger-ui.html";
    private static final String SWAGGER_UI_URL = "/test/swagger-ui/index.html";
    private static final String SWAGGER_CONFIG_URL = "/test/api-docs/swagger-config";
    private static final String OPEN_API_SPEC_URL = "/test/api-docs/test";
    private static final String OAUTH_REDIRECT_URL = "http://localhost/test/swagger-ui/oauth2-redirect.html";
