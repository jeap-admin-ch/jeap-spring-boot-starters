...
class NoBootstrapContextIT {
    ...
    @Test
    void test_WhenNoBootstrapContext_thenReadApplicationConfigFileAndFetchConfigurationFromConfigServerSuccesfully() {
        assertThat(env.getProperty("jme.test.application")).isEqualTo("nobootstrap");
        assertThat(env.getProperty("jme.test.bootstrap")).isNull();
    ...
    private static void stubConfigServerResponse() {
        final String configPath = "/config/test-app/local,nobootstrap";
